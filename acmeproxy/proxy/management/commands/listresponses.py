...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            "--start",
            default=None,
            help="if specified, return only records created after this time",
        )
        parser.add_argument(
            "--end",
            default=None,
            help="if specified, return only records created before this time",
        )
        parser.add_argument(
            "--name",
            default=None,
            help="if specified, return only records for this name",
        )
        ...
        table = [
            {
                ...
                if k in ("expired_at", "created_at", "created_by_ip", "name")
            }
